...
public class BookDAO {
    ...
    public Optional<Person> getBookOwner(int id){
        return jdbcTemplate.query("SELECT Person.* FROM Book JOIN Person ON Book.people_id = Person.id " +
    ...
    public void assign(int id, Person selectedPerson){
        jdbcTemplate.update("UPDATE Book SET people_id = ? where id=?", selectedPerson.getId(), id);
    }
}
